...
1. **提炼正文到 Skill** → `backend-py/app/skills/<agent-type>/<skill-name>/SKILL.md`（目录 + frontmatter 形式；
   本文件是**设计文档，不直接放进 `backend-py/app/skills/`**，目录约定见 `backend-py/app/skills/README.md`）
