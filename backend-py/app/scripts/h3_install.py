...
请直接使用 `backend-py/app/scripts/model_manager.py`：

    python backend-py/app/scripts/model_manager.py list
    python backend-py/app/scripts/model_manager.py download --required
...
# 让 `from h3_install import ...` 与直接 `python backend-py/app/scripts/h3_install.py` 均可工作
