...
用法::
    ...
    python backend-py/app/scripts/check_memory.py                  # 退出码 1 = 存在致命项
    MEMORY_DIR=<目录> python backend-py/app/scripts/check_memory.py   # 仅供 test_guards.py 造故障
"""
...
#: ``backend-py/app/scripts/check_memory.py`` -> 仓库根
