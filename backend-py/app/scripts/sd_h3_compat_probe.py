...
用法：
  python backend-py/app/scripts/sd_h3_compat_probe.py --gguf <path.gguf>          # 静态判定
  python backend-py/app/scripts/sd_h3_compat_probe.py --gguf <path.gguf> --live   # 真机 load
