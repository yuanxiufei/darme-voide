...
Drama Studio 是一个基于 AI 的短剧自动化生产平台，实现从剧本生成、角色设计、分镜制作到视频合成的全流程自动化。
...
| 类型 | 支持厂商 |
|---|---|
| **图片** | OpenAI、Gemini、MiniMax、火山引擎、阿里、第三方代理 |
...
docker run -d \
  ...
  drama-studio/drama-studio:latest

# 查看日志
docker logs -f drama-studio
```
...
[![Star History Chart](https://api.star-history.com/svg?repos=your-org/drama-studio&type=date&legend=top-left)](https://www.star-history.com/#your-org/drama-studio&type=date&legend=top-left)
Made with ❤️ by Drama Studio Contributors
